 ...
 * @date 2021-04-03
 */
@TableName("huochepiao_collection")
public class HuochepiaoCollectionView extends HuochepiaoCollectionEntity implements Serializable {
	...
	public HuochepiaoCollectionView() {

	}

	public HuochepiaoCollectionView(HuochepiaoCollectionEntity huochepiaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, huochepiaoCollectionEntity);
