            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">火车票收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huochepiaoName" id="huochepiaoName" placeholder="火车班次" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huochepiaoChufadi" id="huochepiaoChufadi" placeholder="出发地" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huochepiaoMudidi" id="huochepiaoMudidi" placeholder="目的地" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../huochepiao/detail.jsp?id='+item.huochepiaoId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.huochepiaoPhoto?item.huochepiaoPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../huochepiao/detail.jsp?id='+item.huochepiaoId)"><span>{{item.huochepiaoName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.huochepiaoNewMoney"><span style="color: red;">{{item.huochepiaoNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#huochepiaoName').val() != null && jquery('#huochepiaoName').val() != "" && jquery('#huochepiaoName').val() != "null" ) {
                param['huochepiaoName'] = jquery('#huochepiaoName').val();
            }
                 
            var huochepiaoTypes = $("#huochepiaoTypes").find("option:selected").val();
            if (huochepiaoTypes != null && huochepiaoTypes != "" && huochepiaoTypes != "null") {
                            param['huochepiaoTypes'] = huochepiaoTypes;
                        }
                                 
            if (jquery('#huochepiaoChufadi').val() != null && jquery('#huochepiaoChufadi').val() != "" && jquery('#huochepiaoChufadi').val() != "null" ) {
                param['huochepiaoChufadi'] = jquery('#huochepiaoChufadi').val();
            }
                 
            if (jquery('#huochepiaoMudidi').val() != null && jquery('#huochepiaoMudidi').val() != "" && jquery('#huochepiaoMudidi').val() != "null" ) {
                param['huochepiaoMudidi'] = jquery('#huochepiaoMudidi').val();
            }
                                                                                
            // 当前表
                                // 获取列表数据
            http.request('huochepiaoCollection/list', 'get', param, function(res) {
...
// 级联表的字典表
       ...
       function huochepiaoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huochepiao_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function huochepiaoXinghaoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=huochepiao_xinghao_types", 'get', {}, function (res) {
               if(res.code == 0){
