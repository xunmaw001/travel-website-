            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">飞机票展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="feijipiaoName" id="feijipiaoName" placeholder="飞机班次" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="feijipiaoChufadi" id="feijipiaoChufadi" placeholder="出发地" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="feijipiaoMudidi" id="feijipiaoMudidi" placeholder="目的地" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../feijipiao/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.feijipiaoPhoto?item.feijipiaoPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../feijipiao/detail.jsp?id='+item.id)"><span>{{item.feijipiaoName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.feijipiaoNewMoney"><span style="color: red;">{{item.feijipiaoNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#feijipiaoName').val() != null && jquery('#feijipiaoName').val() != "" && jquery('#feijipiaoName').val() != "null" ) {
                param['feijipiaoName'] = jquery('#feijipiaoName').val();
            }
            ...
            if (jquery('#feijipiaoChufadi').val() != null && jquery('#feijipiaoChufadi').val() != "" && jquery('#feijipiaoChufadi').val() != "null" ) {
                param['feijipiaoChufadi'] = jquery('#feijipiaoChufadi').val();
            }
     
            if (jquery('#feijipiaoMudidi').val() != null && jquery('#feijipiaoMudidi').val() != "" && jquery('#feijipiaoMudidi').val() != "null" ) {
                param['feijipiaoMudidi'] = jquery('#feijipiaoMudidi').val();
            }
                                // 获取列表数据
            http.request('feijipiao/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function feijipiaoXinghaoTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=feijipiao_xinghao_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.feijipiaoXinghaoTypesList = res.data.list;
               }
           });
       }
