            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">酒店收藏展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiudianWeizhi" id="jiudianWeizhi" placeholder="酒店位置" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../jiudian/detail.jsp?id='+item.jiudianId)">
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../jiudian/detail.jsp?id='+item.jiudianId)"><span>{{item.jiudianName}}</span></div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            var jiudianTypes = $("#jiudianTypes").find("option:selected").val();
            if (jiudianTypes != null && jiudianTypes != "" && jiudianTypes != "null") {
                            param['jiudianTypes'] = jiudianTypes;
                        }
                 
            if (jquery('#jiudianWeizhi').val() != null && jquery('#jiudianWeizhi').val() != "" && jquery('#jiudianWeizhi').val() != "null" ) {
                param['jiudianWeizhi'] = jquery('#jiudianWeizhi').val();
            }
                                                                
            // 当前表
                                // 获取列表数据
            http.request('jiudianCollection/list', 'get', param, function(res) {
