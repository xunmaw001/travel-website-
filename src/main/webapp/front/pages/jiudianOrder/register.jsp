              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">预定开始时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiudianOrderStartTime" id="jiudianOrderStartTime"  placeholder="预定开始时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">预定结束时间:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiudianOrderEndTime" id="jiudianOrderEndTime"  placeholder="预定结束时间"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
