	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiudianOrderStartTime" id="jiudianOrderStartTime"  lay-verify="required|date"   placeholder="预定开始时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiudianOrderEndTime" id="jiudianOrderEndTime"  lay-verify="required|date"   placeholder="预定结束时间" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`jiudianOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
