...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的酒店订单 </p>
    </div>
    <!-- 标题 -->
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.jiudianId}}</td>
                        <td style="width: 60px;">{{item.jiudianName}}</td>
                        <td style="width: 80px;">{{item.jiudianValue}}</td>
                        <td style="width: 60px;">{{item.jiudianWeizhi}}</td>
                        <td style="width: 250px;">
                            <img :src="item.jiudianPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                        </td>
                        <td style="width: 100px;color: red">{{item.jiudianNewMoney}}</td>
                        <td style="width: 150px;">{{item.jiudianOrderStartTime}}</td>
                        <td style="width: 150px;">{{item.jiudianOrderEndTime}}</td>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                        // 获取列表数据
            http.request('jiudianOrder/list', 'get', param, function(res) {
