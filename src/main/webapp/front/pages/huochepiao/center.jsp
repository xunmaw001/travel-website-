	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huochepiaoName" id="huochepiaoName" lay-verify="required" placeholder="火车班次" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="huochepiaoTypes" id="huochepiaoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="huochepiaoXinghaoTypes" id="huochepiaoXinghaoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huochepiaoChufadi" id="huochepiaoChufadi" lay-verify="required" placeholder="出发地" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huochepiaoMudidi" id="huochepiaoMudidi" lay-verify="required" placeholder="目的地" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="huochepiaoPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="huochepiaoPhoto" name="huochepiaoPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huochepiaoTime" id="huochepiaoTime" lay-verify="required" placeholder="出发时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huochepiaoNewMoney" id="huochepiaoNewMoney"  lay-verify="required|integer"   placeholder="票价" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`huochepiao/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#huochepiaoPhotoImg").attr("src", data.data.huochepiaoPhoto);
                });
