                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../feijipiao/detail.jsp?id='+item.feijipiaoId)">
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../feijipiao/detail.jsp?id='+item.feijipiaoId)"><span>{{item.feijipiaoName}}</span></div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                // 获取列表数据
            http.request('feijipiaoCollection/list', 'get', param, function(res) {
