            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.feijipiaoId}}</td>
                        <td style="width: 60px;">{{item.feijipiaoName}}</td>
                        <td style="width: 80px;">{{item.feijiValue}}</td>
                        <td style="width: 80px;">{{item.feijipiaoXinghaoValue}}</td>
                        <td style="width: 60px;">{{item.feijipiaoChufadi}}</td>
                        <td style="width: 60px;">{{item.feijipiaoMudidi}}</td>
                        <td style="width: 250px;">
                            <img :src="item.feijipiaoPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                        </td>
                        <td style="width: 60px;">{{item.feijipiaoTime}}</td>
                        <td style="width: 100px;color: red">{{item.feijipiaoNewMoney}}</td>
                        <td style="width: 150px;">{{item.feijipiaoFacheTime}}</td>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                    // 获取列表数据
            http.request('feijipiaoOrder/list', 'get', param, function(res) {
