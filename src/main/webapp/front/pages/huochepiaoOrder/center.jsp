	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="huocheFacheTime" id="huocheFacheTime"  lay-verify="required|date"   placeholder="发车日期" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`huochepiaoOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
