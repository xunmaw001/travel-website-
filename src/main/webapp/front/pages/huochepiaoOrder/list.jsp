...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的火车票订单 </p>
    </div>
    <!-- 标题 -->
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.huochepiaoId}}</td>
                        <td style="width: 60px;">{{item.huochepiaoName}}</td>
                        <td style="width: 80px;">{{item.huochepiaoValue}}</td>
                        <td style="width: 80px;">{{item.huochepiaoXinghaoValue}}</td>
                        <td style="width: 60px;">{{item.huochepiaoChufadi}}</td>
                        <td style="width: 60px;">{{item.huochepiaoMudidi}}</td>
                        <td style="width: 250px;">
                            <img :src="item.huochepiaoPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                        </td>
                        <td style="width: 60px;">{{item.huochepiaoTime}}</td>
                        <td style="width: 100px;color: red">{{item.huochepiaoNewMoney}}</td>
                        <td style="width: 150px;">{{item.huocheFacheTime}}</td>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                    // 获取列表数据
            http.request('huochepiaoOrder/list', 'get', param, function(res) {
