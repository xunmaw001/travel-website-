					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dicCode" id="dicCode" lay-verify="required" placeholder="字段" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dicName" id="dicName" lay-verify="required" placeholder="字段名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="indexName" id="indexName" lay-verify="required" placeholder="编码名字" autocomplete="off" class="layui-input">
							</div>
						</div>
