...
var centerMenu = [
    ...
    ,{
        name: '飞机收藏',
        url: '../feijipiaoCollection/list.jsp'
    }
    ,{
        name: '飞机订单',
        url: '../feijipiaoOrder/list.jsp'
    }
    ,{
        name: '火车票收藏',
        url: '../huochepiaoCollection/list.jsp'
    }
    ,{
        name: '火车票订单',
        url: '../huochepiaoOrder/list.jsp'
    }
    ,{
        name: '景点收藏',
...
var indexNav = [
    ...
    {
        name: '飞机票',
        url: './pages/feijipiao/list.jsp'
    },
    {
        name: '火车票',
        url: './pages/huochepiao/list.jsp'
    },
    {
        name: '景点',
