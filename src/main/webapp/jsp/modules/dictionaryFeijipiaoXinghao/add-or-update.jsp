    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑飞机型号</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">飞机型号管理</li>
                        <li class="breadcrumb-item active">编辑飞机型号</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">飞机型号表信息</h3>
...
<script>
    ...
    var tableName = "dictionary_feijipiaoXinghao";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "feijipiaoXinghao_types";
            data["dicName"] = "飞机型号名称";
