            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">酒店登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function exit() {
        ...
        window.sessionStorage.removeItem('addjiudian');
